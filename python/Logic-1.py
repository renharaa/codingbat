...
def caught_speeding(speed, is_birthday):
	...
	return 2 if (speeding > 20) else 1 if (speeding > 0) else 0
...
def alarm_clock(day, vacation):
	...
	wdays = "7:00" if not vacation else "10:00"
	wend = "10:00" if not vacation else "off"
	return wdays if day in range(1,6) else wend
